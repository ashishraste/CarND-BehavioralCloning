...
# Load training and validation data, and creating their respective generators.
...
# Train the nVidia end-to-end model and evaluate it over validation set.
...
# Plot mean-squared loss over training and validation sets.
